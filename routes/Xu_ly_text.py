...
def replace_comma_in_numbers(text):
    # This regex will match numbers with commas, such as 1,000 or 3,500,000
    return re.sub(r"(?<=\d),(?=\d)", "phẩy", text)


def Xu_ly_text_de_doc(text: str):
    # text = text.lower()
    text = replace_comma_in_numbers(text=text)
